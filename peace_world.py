...
def peace_text_ascii_generator(text):
    ...
    count = 0
    for i in format_font:
        count=count+1
        if count in index_fonts:
            result = pyfiglet.figlet_format(text,font=i)
            print("""==================================================""")
            print(result)
            print("""==================================================""")
            time.sleep(1)
